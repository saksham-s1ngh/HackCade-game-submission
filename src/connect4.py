...
sharkImg = pygame.image.load('E:\Hackcade\envs\c4env\src\shark.png')
watermelonImg = pygame.image.load('E:\Hackcade\envs\c4env\src\watermelon.png')
            ...
            if turn == 0:
                ...
                if is_valid_location(board, col):
                    ...
                    if winning_move(board, 1):
                        label = myfont.render("Player 1 Victory Royale! GG! WP!", 1 , GREY)
            ...
            #ask for Player 2 input
                ...
                if is_valid_location(board, col):
                    ...
                    if winning_move(board, 2):
                        label = myfont.render("Player 2 Victory Royale! GG! WP!", 1 , GREEN)
                        screen.blit(label, (40,10))
                        game_over = True
